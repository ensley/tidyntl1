...
% title / author / date
\title{Predicting Location via Indoor Positioning Systems}
\author{John Ensley}
\date{2017-10-11}
...
This is a case study from Chapter 1 of \textbf{Data Science in R}
\citep{Nolan:2015:DSR:2821191}.
...
\subsubsection{Margin Figures}\label{margin-figures}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/fig-margin-1} \caption[MPG vs horsepower, colored by transmission]{MPG vs horsepower, colored by transmission.}\label{fig:fig-margin}
\end{marginfigure}
...
\subsubsection{Arbitrary Margin Content}\label{arbitrary-margin-content}
...
\subsubsection{Full Width Figures}\label{full-width-figures}
...
\begin{figure*}
\includegraphics{_main_files/figure-latex/fig-fullwidth-1} \caption[A full width figure]{A full width figure.}\label{fig:fig-fullwidth}
\end{figure*}
...
\subsubsection{Main Column Figures}\label{main-column-figures}
...
\begin{figure}
\includegraphics{_main_files/figure-latex/fig-main-1} \caption[A figure in the main column]{A figure in the main column.}\label{fig:fig-main}
\end{figure}
...
\subsection{Responsiveness}\label{responsiveness}
...
\begin{figure}
\includegraphics{_main_files/figure-latex/fig-two-together-1} \includegraphics{_main_files/figure-latex/fig-two-together-2} \caption[Two plots in one figure environment]{Two plots in one figure environment.}\label{fig:fig-two-together}
\end{figure}
...
\begin{figure}
\includegraphics{_main_files/figure-latex/fig-two-separate-1} \caption[Two plots in separate figure environments (the first plot)]{Two plots in separate figure environments (the first plot).}\label{fig:fig-two-separate1}
\end{figure}
...
\begin{figure}
\includegraphics{_main_files/figure-latex/fig-two-separate-2} \caption[Two plots in separate figure environments (the second plot)]{Two plots in separate figure environments (the second plot).}\label{fig:fig-two-separate2}
\end{figure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/fig-margin-together-1} \includegraphics{_main_files/figure-latex/fig-margin-together-2} \caption[Two plots in one figure environment in the margin]{Two plots in one figure environment in the margin.}\label{fig:fig-margin-together}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/fig-margin-separate-1} \caption[Two plots in separate figure environments in the margin (the first plot)]{Two plots in separate figure environments in the margin (the first plot).}\label{fig:fig-margin-separate1}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/fig-margin-separate-2} \caption[Two plots in separate figure environments in the margin (the second plot)]{Two plots in separate figure environments in the margin (the second plot).}\label{fig:fig-margin-separate2}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/fig-nocap-margin-1} \end{marginfigure}
...
\includegraphics{_main_files/figure-latex/fig-nocap-main-1}
...
\begin{figure*}
\includegraphics{_main_files/figure-latex/fig-nocap-fullwidth-1} \end{figure*}

\subsection{Some Notes on Tufte CSS}\label{some-notes-on-tufte-css}
...
\includegraphics{_main_files/figure-latex/pressure-1}

Note that the \texttt{echo\ =\ FALSE} parameter was added to the code
chunk to prevent printing of the R code that generated the plot.

\bibliography{references.bib,skeleton.bib}
