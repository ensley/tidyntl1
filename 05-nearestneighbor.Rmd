...
Figure \@ref(cverr) shows the sum of squared errors as a function of $k$. We see that the errors decrease quite a lot at first, e.g., for $k = 1, \dots, 7$; then the errors begin to increase slowly because the neighbors become too spread out geographically.
